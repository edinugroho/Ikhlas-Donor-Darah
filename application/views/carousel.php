  ...
  <ul class="slides">
    <li>
      ...
      <div class="caption center-align">
        <h3 class="black-text text-darken-2">Ikhlas Donor</h3>
        <h5 class="black-text text-darken-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo quaerat ab magnam, error, ipsam, sequi explicabo blanditiis qui sunt perspiciatis quasi reprehenderit officia laborum, natus ullam iusto eaque nemo impedit.</h5>
      </div>
    </li>
    <li>
    ...
    <li>
      ...
      <div class="caption right-align">
        <h3 class="teal-text text-darken-2">Klik Mulai Untuk menggunakan Fitur</h3>
        <h5 class="light black-text text-lighten-3">Mulai Aja dulu</h5>
